...
namespace FSF.CollectionFrame
{
    ...
    public class LyricValueKey
    {
        ...
        /// </summary>
        [TextArea(5, 25)] public string Lyric;
    ...
    public static class LyricSpliter
    {
        ...
        /// when true, when counter the lyrics are in the same time,the first lyric will place in first line, the second lyric will place in second line.</param>
